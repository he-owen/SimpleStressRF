...
def count_unique_rgb_values(df, r_column, g_column, b_column, attribute):
    ...
    print("RGB Tuple to Integer Mapping:")
    for rgb_tuple, integer_mapping in tuple_to_int_mapping.items():
        print(f"{rgb_tuple} -> {integer_mapping}")
    return df, tuple_to_int_mapping
...
df,SkinColorMap = count_unique_rgb_values(df, 'SkinColor.r', 'SkinColor.g', 'SkinColor.b', "SkinColor")
df,EyeColorMap = count_unique_rgb_values(df, 'EyeColor.r', 'EyeColor.g', 'EyeColor.b', "EyeColor")
df,HairColorMap = count_unique_rgb_values(df, 'HairColor.r', 'HairColor.g', 'HairColor.b', "HairColor")
