...
df.loc[df.SkinColor.r == "0", 'SkinColor.r'] = "0"
df.loc[df.SkinColor.r == "1", 'SkinColor.r'] = "1"
df.loc[df.SkinColor.r == "2", 'SkinColor.r'] = "2"
df.loc[df.SkinColor.r == "3", 'SkinColor.r'] = "3"
df.loc[df.SkinColor.r == "4", 'SkinColor.r'] = "4"
df.loc[df.SkinColor.r == "5", 'SkinColor.r'] = "5"
df.loc[df.SkinColor.r == "6", 'SkinColor.r'] = "6"
df.loc[df.SkinColor.r == "7", 'SkinColor.r'] = "7"
df.loc[df.SkinColor.r == "8", 'SkinColor.r'] = "8"

df["SkinColor.r"] = df["SkinColor.r"].astype(int)
...
CategoryLabels = list(df["SkinColor.r"])
...
Category0_data = df[df['SkinColor.r'] == 0]
Category1_data = df[df['SkinColor.r'] == 1]
Category2_data = df[df['SkinColor.r'] == 2]
Category3_data = df[df['SkinColor.r'] == 3]
Category4_data = df[df['SkinColor.r'] == 4]
Category5_data = df[df['SkinColor.r'] == 5]
Category6_data = df[df['SkinColor.r'] == 6]
Category7_data = df[df['SkinColor.r'] == 7]
Category8_data = df[df['SkinColor.r'] == 8]
...
training_labels = train['SkinColor.r'].values + 1
test_corpus = test['AnswerCombined'].values
test_labels = test['SkinColor.r'].values + 1
