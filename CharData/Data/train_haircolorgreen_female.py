...
df.loc[df.HairColor.g == "0", 'HairColor.g'] = "0"
df.loc[df.HairColor.g == "1", 'HairColor.g'] = "1"
df.loc[df.HairColor.g == "2", 'HairColor.g'] = "2"
df.loc[df.HairColor.g == "3", 'HairColor.g'] = "3"
df.loc[df.HairColor.g == "4", 'HairColor.g'] = "4"
df.loc[df.HairColor.g == "5", 'HairColor.g'] = "5"
df.loc[df.HairColor.g == "6", 'HairColor.g'] = "6"
df.loc[df.HairColor.g == "7", 'HairColor.g'] = "7"
df.loc[df.HairColor.g == "8", 'HairColor.g'] = "8"
df.loc[df.HairColor.g == "9", 'HairColor.g'] = "9"
df.loc[df.HairColor.g == "10", 'HairColor.g'] = "10"
df.loc[df.HairColor.g == "11", 'HairColor.g'] = "11"

df["HairColor.g"] = df["HairColor.g"].astype(int)
...
CategoryLabels = list(df["HairColor.g"])
...
Category0_data = df[df['HairColor.g'] == 0]
Category1_data = df[df['HairColor.g'] == 1]
Category2_data = df[df['HairColor.g'] == 2]
Category3_data = df[df['HairColor.g'] == 3]
Category4_data = df[df['HairColor.g'] == 4]
Category5_data = df[df['HairColor.g'] == 5]
Category6_data = df[df['HairColor.g'] == 6]
Category7_data = df[df['HairColor.g'] == 7]
Category8_data = df[df['HairColor.g'] == 8]
Category9_data = df[df['HairColor.g'] == 9]
Category10_data = df[df['HairColor.g'] == 10]
Category11_data = df[df['HairColor.g'] == 11]
...
training_labels = train['HairColor.g'].values + 1
test_corpus = test['AnswerCombined'].values
test_labels = test['HairColor.g'].values + 1
