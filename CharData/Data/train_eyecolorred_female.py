...
df.loc[df.EyeColor.r == "0", 'EyeColor.r'] = "0"
df.loc[df.EyeColor.r == "1", 'EyeColor.r'] = "1"
df.loc[df.EyeColor.r == "2", 'EyeColor.r'] = "2"
df.loc[df.EyeColor.r == "3", 'EyeColor.r'] = "3"
df.loc[df.EyeColor.r == "4", 'EyeColor.r'] = "4"
df.loc[df.EyeColor.r == "5", 'EyeColor.r'] = "5"
df.loc[df.EyeColor.r == "6", 'EyeColor.r'] = "6"

df["EyeColor.r"] = df["EyeColor.r"].astype(int)
...
CategoryLabels = list(df["EyeColor.r"])
...
Category0_data = df[df['EyeColor.r'] == 0]
Category1_data = df[df['EyeColor.r'] == 1]
Category2_data = df[df['EyeColor.r'] == 2]
Category3_data = df[df['EyeColor.r'] == 3]
Category4_data = df[df['EyeColor.r'] == 4]
Category5_data = df[df['EyeColor.r'] == 5]
Category6_data = df[df['EyeColor.r'] == 6]
...
training_labels = train['EyeColor.r'].values + 1
test_corpus = test['AnswerCombined'].values
test_labels = test['EyeColor.r'].values + 1
