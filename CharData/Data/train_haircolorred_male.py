...
df.loc[df.HairColor.r == "0", 'HairColor.r'] = "0"
df.loc[df.HairColor.r == "1", 'HairColor.r'] = "1"
df.loc[df.HairColor.r == "2", 'HairColor.r'] = "2"
df.loc[df.HairColor.r == "3", 'HairColor.r'] = "3"
df.loc[df.HairColor.r == "4", 'HairColor.r'] = "4"
df.loc[df.HairColor.r == "5", 'HairColor.r'] = "5"
df.loc[df.HairColor.r == "6", 'HairColor.r'] = "6"
df.loc[df.HairColor.r == "7", 'HairColor.r'] = "7"
df.loc[df.HairColor.r == "8", 'HairColor.r'] = "8"
df.loc[df.HairColor.r == "9", 'HairColor.r'] = "9"
df.loc[df.HairColor.r == "10", 'HairColor.r'] = "10"
df.loc[df.HairColor.r == "11", 'HairColor.r'] = "11"

df["HairColor.r"] = df["HairColor.r"].astype(int)
...
CategoryLabels = list(df["HairColor.r"])
...
Category0_data = df[df['HairColor.r'] == 0]
Category1_data = df[df['HairColor.r'] == 1]
Category2_data = df[df['HairColor.r'] == 2]
Category3_data = df[df['HairColor.r'] == 3]
Category4_data = df[df['HairColor.r'] == 4]
Category5_data = df[df['HairColor.r'] == 5]
Category6_data = df[df['HairColor.r'] == 6]
Category7_data = df[df['HairColor.r'] == 7]
Category8_data = df[df['HairColor.r'] == 8]
Category9_data = df[df['HairColor.r'] == 9]
Category10_data = df[df['HairColor.r'] == 10]
Category11_data = df[df['HairColor.r'] == 11]
...
training_labels = train['HairColor.r'].values + 1
test_corpus = test['AnswerCombined'].values
test_labels = test['HairColor.r'].values + 1
