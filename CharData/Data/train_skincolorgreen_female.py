...
# Data Values: 0 1 2 3 4 5 6 7 8
# Convert label column to numeric labels
df.loc[df.SkinColor.g == "0", 'SkinColor.g'] = "0"
df.loc[df.SkinColor.g == "1", 'SkinColor.g'] = "1"
df.loc[df.SkinColor.g == "2", 'SkinColor.g'] = "2"
df.loc[df.SkinColor.g == "3", 'SkinColor.g'] = "3"
df.loc[df.SkinColor.g == "4", 'SkinColor.g'] = "4"
df.loc[df.SkinColor.g == "5", 'SkinColor.g'] = "5"
df.loc[df.SkinColor.g == "6", 'SkinColor.g'] = "6"
df.loc[df.SkinColor.g == "7", 'SkinColor.g'] = "7"
df.loc[df.SkinColor.g == "8", 'SkinColor.g'] = "8"

df["SkinColor.g"] = df["SkinColor.g"].astype(int)
...
CategoryLabels = list(df["SkinColor.g"])
...
Category0_data = df[df['SkinColor.g'] == 0]
Category1_data = df[df['SkinColor.g'] == 1]
Category2_data = df[df['SkinColor.g'] == 2]
Category3_data = df[df['SkinColor.g'] == 3]
Category4_data = df[df['SkinColor.g'] == 4]
Category5_data = df[df['SkinColor.g'] == 5]
Category6_data = df[df['SkinColor.g'] == 6]
Category7_data = df[df['SkinColor.g'] == 7]
Category8_data = df[df['SkinColor.g'] == 8]
...
training_labels = train['SkinColor.g'].values + 1
test_corpus = test['AnswerCombined'].values
test_labels = test['SkinColor.g'].values + 1
