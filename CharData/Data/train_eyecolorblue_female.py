...
df.loc[df.EyeColor.b == "0", 'EyeColor.b'] = "0"
df.loc[df.EyeColor.b == "1", 'EyeColor.b'] = "1"
df.loc[df.EyeColor.b == "2", 'EyeColor.b'] = "2"
df.loc[df.EyeColor.b == "3", 'EyeColor.b'] = "3"
df.loc[df.EyeColor.b == "4", 'EyeColor.b'] = "4"
df.loc[df.EyeColor.b == "5", 'EyeColor.b'] = "5"
df.loc[df.EyeColor.b == "6", 'EyeColor.b'] = "6"

df["EyeColor.b"] = df["EyeColor.b"].astype(int)
...
CategoryLabels = list(df["EyeColor.b"])
...
Category0_data = df[df['EyeColor.b'] == 0]
Category1_data = df[df['EyeColor.b'] == 1]
Category2_data = df[df['EyeColor.b'] == 2]
Category3_data = df[df['EyeColor.b'] == 3]
Category4_data = df[df['EyeColor.b'] == 4]
Category5_data = df[df['EyeColor.b'] == 5]
Category6_data = df[df['EyeColor.b'] == 6]
...
training_labels = train['EyeColor.b'].values + 1
test_corpus = test['AnswerCombined'].values
test_labels = test['EyeColor.b'].values + 1
