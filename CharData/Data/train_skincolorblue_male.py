...
df.loc[df.SkinColor.b == "0", 'SkinColor.b'] = "0"
df.loc[df.SkinColor.b == "1", 'SkinColor.b'] = "1"
df.loc[df.SkinColor.b == "2", 'SkinColor.b'] = "2"
df.loc[df.SkinColor.b == "3", 'SkinColor.b'] = "3"
df.loc[df.SkinColor.b == "4", 'SkinColor.b'] = "4"
df.loc[df.SkinColor.b == "5", 'SkinColor.b'] = "5"
df.loc[df.SkinColor.b == "6", 'SkinColor.b'] = "6"
df.loc[df.SkinColor.b == "7", 'SkinColor.b'] = "7"
df.loc[df.SkinColor.b == "8", 'SkinColor.b'] = "8"

df["SkinColor.b"] = df["SkinColor.b"].astype(int)
...
CategoryLabels = list(df["SkinColor.b"])
...
Category0_data = df[df['SkinColor.b'] == 0]
Category1_data = df[df['SkinColor.b'] == 1]
Category2_data = df[df['SkinColor.b'] == 2]
Category3_data = df[df['SkinColor.b'] == 3]
Category4_data = df[df['SkinColor.b'] == 4]
Category5_data = df[df['SkinColor.b'] == 5]
Category6_data = df[df['SkinColor.b'] == 6]
Category7_data = df[df['SkinColor.b'] == 7]
Category8_data = df[df['SkinColor.b'] == 8]
...
training_labels = train['SkinColor.b'].values + 1
test_corpus = test['AnswerCombined'].values
test_labels = test['SkinColor.b'].values + 1
